...
Future<void> injectRepository({
  ...
  ServiceLocator.instance.put<LanguageRepository>(LanguageRepositoryImpl(
    languageService,
  ));
  ...
  final connectivityRepository = ServiceLocator.instance
      .put<ConnectivityRepository>(ConnectivityRepositoryImpl(
    connectivity,
    internetChecker,
  ));
  ...
  ServiceLocator.instance.put<TrendingRepository>(
      TrendingRepositoryImpl(TrendingAPI(http, languageService)));

  ServiceLocator.instance.put<MoviesRepository>(
      MoviesRepositoryImpl(MoviesAPI(http, languageService)));
